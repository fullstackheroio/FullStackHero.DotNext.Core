...
public class Int64ToStringConverter : JsonConverter<long>
{
    ...
    /// <summary>Reads and converts the JSON to type Int64.</summary>
    ...
    public override long Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        switch (reader.TokenType)
        {
            ...
            case JsonTokenType.String:
                ...
                if (Utf8Parser.TryParse(source, out long value, out var bytesConsumed) && source.Length == bytesConsumed) return value;

                // try to parse from a string if the above failed, this covers cases with other escaped/UTF characters
                return long.TryParse(reader.GetString(), out var result) ? result : default;
